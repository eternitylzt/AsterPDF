...
| PySide6, Shiboken6, Qt 6.10.2 (Windows/macOS), 6.8.3 (Linux) | LGPL-3.0 option; Qt/PySide modules may also offer GPL/commercial alternatives | https://code.qt.io/cgit/pyside/pyside-setup.git/ ; https://download.qt.io/official_releases/qt/6.10/6.10.2/single/ ; https://download.qt.io/official_releases/qt/6.8/6.8.3/single/ |

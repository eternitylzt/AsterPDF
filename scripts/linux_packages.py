...
Priority: optional
Installed-Size: {size}
Depends: libc6 (>= 2.28), libstdc++6, libgcc-s1 | libgcc1, libgl1, libegl1, libx11-6, libxcb1, libxkbcommon0, libxkbcommon-x11-0, libfontconfig1, libdbus-1-3, libasound2 | libasound2t64, libpulse0, libxrandr2, libatomic1, libcups2 | libcups2t64, libgl1-mesa-dri, fonts-dejavu-core
...
BuildArch: x86_64
AutoReqProv: no
Requires: glibc >= 2.28, libstdc++, libgcc, mesa-libGL, mesa-libEGL, libX11, libxcb, libxkbcommon, libxkbcommon-x11, fontconfig, dbus-libs, alsa-lib, pulseaudio-libs, libXrandr, libatomic, cups-libs, mesa-dri-drivers, dejavu-sans-fonts
%description
